...
function renderAuth() {
  ...
  <div class="s" style="max-width:520px;margin:0 auto;padding-top:5rem">
    ...
    <div class="tabs reveal" style="margin-bottom:2rem">
    ...
    <!-- LOGIN -->
    <div id="auth-login" class="glass-lg reveal" style="padding:2.5rem">
      ...
      <div class="glass reveal" style="padding:2rem;text-align:left;border-color:rgba(124,58,237,0.2)">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:0.8rem">
          ${Object.entries(STN.PROMO_CODES).map(([code, info]) => `
            <div style="background:rgba(255,255,255,0.03);border:1px solid rgba(124,58,237,0.15);border-radius:var(--radius-sm);padding:1rem;display:flex;justify-content:space-between;align-items:center;gap:0.8rem">
              <div>
