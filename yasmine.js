...
var GEMINI_KEY = "AIzaSyDrpm51A5UBYQebJSdcteTvcI2dJ2i9gd4";
...
function setLang(lang) {
  ...
  if (typeof toast === 'function') {
    var labels = { ar: 'AR - \u0639\u0631\u0628\u064a', fr: 'FR - Fran\u00e7ais', en: 'EN - English' };
    toast(labels[lang], 'default');
  }
}
...
var AI = (function() {
  ...
  function getOfflineReply(msg) {
    ...
    if (m.includes('livr') || m.includes('delivery'))
      return currentLang === 'en' ? 'Delivery in 24-48h across Tunisia. Free over 500 TND!' : 'Livraison en 24-48h en Tunisie. Gratuite au-dessus de 500 TND!';
    if (m.includes('promo') || m.includes('code'))
      return currentLang === 'en' ? 'Use SAHEL20 for 20% off or WELCOME50 for 50 TND off!' : 'Utilisez SAHEL20 (-20%) ou WELCOME50 (-50 TND)!';
    return currentLang === 'en' ? 'Hello! How can I help you with Shopping today?' : currentLang === 'ar' ? '\u0645\u0631\u062d\u0628\u0627! \u0643\u064a\u0641 \u064a\u0645\u0643\u0646\u0646\u064a \u0645\u0633\u0627\u0639\u062f\u062a\u0643?' : 'Bonjour! Comment puis-je vous aider avec Shopping?';
  }
  ...
  function appendMsg(role, text, typing) {
    ...
    var avatar = role === 'bot' ? '<div style="width:28px;height:28px;border-radius:50%;background:linear-gradient(135deg,#7c3aed,#9b72f0);display:flex;align-items:center;justify-content:center;font-size:0.7rem;flex-shrink:0">\u2728</div>' : '';
  ...
  function toggle() {
    ...
    if (isOpen && !document.querySelector('.ym-msg')) {
      appendMsg('bot', currentLang === 'ar' ? '\u0645\u0631\u062d\u0628\u0627! \u0623\u0646\u0627 \u064a\u0627\u0633\u0645\u064a\u0646\u060c \u0643\u064a\u0641 \u064a\u0645\u0643\u0646\u0646\u064a \u0645\u0633\u0627\u0639\u062f\u062a\u0643?' : currentLang === 'en' ? "Hi! I'm Yasmine. How can I help?" : "Bonjour! Je suis Yasmine. Comment puis-je vous aider?");
    }
  }
  ...
  return {
    ...
    key: function(e) { if (e.key === 'Enter') { var inp = document.getElementById('yasmine-input'); if (inp && inp.value.trim()) { sendMessage(inp.value.trim()); inp.value = ''; } } },
    quick: function(text) { sendMessage(text); },
